...
var mySoundArray = ["fart-wav-4.wav","drum1.wav","fanfare.wav", "fanfare2.wav","sheepBaa.wav", "drum2.wav","drum3.wav","drum4.wav","drum5.wav"];

var myImageArray =["bonnie50.jpg", "devil50.gif", "lotus50.gif","mySheep50.jpg"];

var myBonnieSoundChoice = mySoundArray[4];
var myDevilSoundChoice = mySoundArray[0];
var myBonusSoundChoice = mySoundArray[3];

var bonnie = "<img src =\"./images/" + myImageArray[3] + "\" alt = \"Sheep\" />"
...
function randomArrayAdvanced(pick, mylower, myUpper) {
 ...
 function stopTheGame () {if (score > 100) {hideDivs(); }}
